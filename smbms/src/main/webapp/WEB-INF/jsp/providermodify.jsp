...
<div class="right">
    ...
    <div class="providerAdd">
        <form id="providerForm" enctype="multipart/form-data" name="providerForm" method="post"
              action="${pageContext.request.contextPath }/provider/modifysave.html">
            ...
            <c:if test="${str!=null}">
                ...
                <div>
                    <label>附件：</label>
                    <img style="width: 60px;height: 60px" src="../../statics/upload/${stww}"/>
                </div>
            </c:if>
            <c:if test="${str==null}">
                <div>
                    <label for="a_idPicPath">上传附件：</label>
                    <input type="file" name="a_idPicPath" id="a_idPicPath" value=""/>
                    <font color="red">${uploadFileError}</font>
                </div>
                <div>
                    <label for="a_workPicPath">工作证：</label>
