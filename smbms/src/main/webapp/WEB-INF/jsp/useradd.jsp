...
<div class="right">
        ...
        <div class="providerAdd">
            <fm:form id="userForm" enctype="multipart/form-data" modelAttribute="user" name="userForm" method="post" action="${pageContext.request.contextPath }/user/addusersave.html">
